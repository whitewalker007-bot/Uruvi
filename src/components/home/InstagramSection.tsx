...
const INSTAGRAM_IMAGES = [
  FASHION_IMAGES.instagram1,
  FASHION_IMAGES.instagram2,
  FASHION_IMAGES.instagram3,
  FASHION_IMAGES.instagram4,
  FASHION_IMAGES.instagram5,
  FASHION_IMAGES.instagram6,
];
          ...
          {INSTAGRAM_IMAGES.map((src, i) => (
            <div key={i} className="group relative aspect-square overflow-hidden">
              ...
              <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-colors duration-300 flex items-center justify-center">
                <svg
                  className="w-6 h-6 fill-current text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                  viewBox="0 0 24 24"
                >
