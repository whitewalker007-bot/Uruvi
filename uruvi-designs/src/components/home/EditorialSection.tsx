        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="lg:pl-8">
            ...
            <h2 className="font-serif text-[#1A1A1A] mb-6" style={{ fontSize: "clamp(2.5rem, 5vw, 4rem)", lineHeight: 1.08, letterSpacing: "-0.02em" }}>
              The<br />
              <em className="text-[#C9A84C] not-italic font-light">Uruvi</em><br />
              Edit
            </h2>
            ...
            <p className="text-[#5C5C5C] text-base leading-relaxed mb-4 max-w-[40ch]">
              Where contemporary design meets the timeless spirit of Indian fashion. Each piece in The Uruvi Edit is chosen for its ability to move effortlessly through your life.
            </p>
