    ...
    <div className="bg-[#FAFAF8] min-h-screen py-12">
      <div className="container-uruvi max-w-3xl">
        ...
        <div className="space-y-6 text-sm text-[#5C5C5C] leading-relaxed">
          <p>
            Welcome to <strong>URUVI DESIGNS</strong>. By accessing or using our website, you agree to comply with and be bound by the following terms and conditions.
          </p>

          <h2 className="font-serif text-xl font-semibold text-[#1A1A1A] pt-4">1. Intellectual Property</h2>
          <p>
            All content on this website—including images, text, logos, graphics, and apparel designs—is the exclusive property of URUVI DESIGNS and protected by copyright laws.
          </p>
